...
class TextModels(Enum):
    ...
    GEMINI_2_5_FLASH        = ModelAsPar(Models.GEMINI_2_5_FLASH, "Gemini 2.5 Flash")
    GEMINI_2_5_PRO          = ModelAsPar(Models.GEMINI_2_5_PRO, "Gemini 2.5 Pro")
    GEMINI_3_FLASH_PREVIEW  = ModelAsPar(Models.GEMINI_3_FLASH_PREVIEW, "Gemini 3 Flash Preview")
    GEMINI_3_1_PRO_PREVIEW  = ModelAsPar(Models.GEMINI_3_1_PRO_PREVIEW, "Gemini 3.1 Pro Preview")
    GEMINI_3_1_FLASH_LITE   = ModelAsPar(Models.GEMINI_3_1_FLASH_LITE_PREVIEW, "Gemini 3.1 Flash Lite Preview")
...
class ImageModels(Enum):
    ...
    NANO_BANANA_PRO     = ModelAsPar(Models.GEMINI_3_PRO_IMAGE_PREVIEW, "Nano Banana Pro")
    NANO_BANANA_2       = ModelAsPar(Models.GEMINI_3_1_FLASH_IMAGE_PREVIEW, "Nano Banana 2")

    # Actual
    GEMINI_3_0_PRO_IMAGE_PREVIEW    = ModelAsPar(Models.GEMINI_3_PRO_IMAGE_PREVIEW, "Gemini 3.0 Pro Image Preview")
    GEMINI_3_1_PRO_IMAGE_PREVIEW    = ModelAsPar(Models.GEMINI_3_PRO_IMAGE_PREVIEW, "Gemini 3.1 Pro Image Preview")
    GEMINI_3_1_FLASH_IMAGE_PREVIEW  = ModelAsPar(Models.GEMINI_3_1_FLASH_IMAGE_PREVIEW, "Gemini 3.1 Flash Image Preview")
    GEMINI_2_5_FLASH_IMAGE          = ModelAsPar(Models.GEMINI_2_5_FLASH_IMAGE, "Gemini 2.5 Flash Image")
    IMAGEN_3_0_GENERATE_002         = ModelAsPar(Models.IMAGEN_3_0_GENERATE_002, "Imagen 3.0 Generate 002")
    IMAGEN_3_0_FAST_GENERATE_001    = ModelAsPar(Models.IMAGEN_3_0_FAST_GENERATE_001, "Imagen 3.0 Fast Generate 001")
    IMAGEN_4_0_GENERATE_PREDICT     = ModelAsPar(Models.IMAGEN_4_0_GENERATE_PREDICT, "Imagen 4.0 Generate Predict")
...
class AudioModels(Enum):
    ...
    LYRIA_002               = ModelAsPar(Models.LYRIA_002, "Lyria 002")
...
class TTSModels(Enum):
    ...
    GEMINI_2_5_FLASH_PREVIEW_TTS    = ModelAsPar(Models.GEMINI_2_5_FLASH_TTS, "Gemini 2.5 Flash Preview TTS")
